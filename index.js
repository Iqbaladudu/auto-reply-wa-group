...
var custom_data4 = fs.readFileSync("./data/iklan.txt", "utf-8");
                        ...
                        return __generator(this, function (_j) {
                            switch (_j.label) {
                                case 0:
                                    ...
                                    if (!(shouldReconnect ||
                                        ((_e = (_d = lastDisconnect === null || lastDisconnect === void 0 ? void 0 : lastDisconnect.error) === null || _d === void 0 ? void 0 : _d.output) === null || _e === void 0 ? void 0 : _e.statusCode) ===
                                            baileys_1.DisconnectReason.timedOut)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, connectToWhatsApp()];
                                case 1:
                                    _j.sent();
                                    return [3 /*break*/, 3];
                                case 2:
                                ...
                                case 4:
                                    ...
                                    _j.label = 5;
                                case 5:
                                    if (!events["connection.update"]) return [3 /*break*/, 7];
                                    return [4 /*yield*/, saveCreds()];
                                case 6:
                                    _j.sent();
                                    _j.label = 7;
                                case 7:
                                    if (!events["messages.upsert"]) return [3 /*break*/, 12];
                                    upsert = events["messages.upsert"];
                                    console.log("recv messages ", upsert.messages[0]);
                                    if (!(upsert.type === "notify")) return [3 /*break*/, 12];
                                    _i = 0, _a = upsert.messages;
                                    _j.label = 8;
                                case 8:
                                    if (!(_i < _a.length)) return [3 /*break*/, 12];
                                    msg = _a[_i];
                                    if (!(!msg.key.fromMe && ((_h = msg.key.remoteJid) === null || _h === void 0 ? void 0 : _h.endsWith("g.us")))) return [3 /*break*/, 11];
...
// run in main file
connectToWhatsApp().then(function (r) { return console.log("Connected"); });
